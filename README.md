...
4. **Model Evaluation**:
   ...
   - Since the dataset is highly imbalanced, the F1 score is particularly useful to balance the precision and recall.
...
- **Libraries**:
  ...
  - `scikit-learn`: Machine learning algorithms and tools for model training, evaluation, and metrics.
